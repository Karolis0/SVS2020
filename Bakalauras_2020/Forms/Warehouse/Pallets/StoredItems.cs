...
{
    public partial class StoredItems : BTpl
    {
        public StoredItems()
        {
            InitializeComponent();
        ...
        {
            dView.Columns["StoredItemId"].Visible = false;
        ...
        private void TranslateColumns(DataGridView dView)
        {
            ...
            dView.Columns["ItemBarcode"].HeaderText = "Prekės barkodas";
            dView.Columns["Description"].HeaderText = "Prekės pavadinimas";
        ...
        {
            base.BeforeDataLoad();
            SelectSql = "SelectStoredItems";
            FormMainId = "StoredItemId";
        }
    }
}
